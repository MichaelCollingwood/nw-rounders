export default function Page() {
    return (
        <div className="block-list p-10 gap-1">
            ...
            <li>Too much chat £1</li>
            <li>Not enough chat 50p</li>
            <li>Drinking the night before £1</li>
            <li>No warm up 50p</li>
            <li>Unavailable for a match 50p</li>
            <li>Arguing a fine £2</li>
